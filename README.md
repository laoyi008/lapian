# 欢迎使用你的秒哒应用代码包
秒哒应用链接
    URL:https://www.miaoda.cn/projects/app-7z9dk2hyx5hd

## 介绍

短视频拉片分析工具 - 专业的短视频分析与创作辅助平台，帮助用户对短视频进行深度拆解分析（包括画面和音频），并生成AI视频生成提示词，提升视频创作效率。

### 核心功能

- **视频上传**：支持常见视频格式（MP4、MOV等）
- **智能分镜**：自动提取视频关键帧，AI分析每个镜头的内容、场景、构图等
- **音频识别**：提取视频音频，识别语音内容，整合到分镜分析中
- **综合分析**：将画面和音频分析整合，生成完整的视频拉片报告
- **AI提示词生成**：基于分析结果，自动生成适合AI视频生成工具使用的专业提示词
- **一键复制**：支持分析结果和提示词的快速复制

### 技术特点

- 使用百度智能云图像内容理解API进行画面分析
- 使用百度智能云短语音识别API进行音频识别
- 使用百度智能云文心大模型生成AI提示词
- 深蓝色科技风格UI设计，专业且现代
